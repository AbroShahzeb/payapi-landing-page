...
export const About = () => {
  return (
    <main className="min-h-screen w-full bg-[#EDF3F8] relative overflow-hidden ">
      ...
      <div className="px-6 lg:max-w-[1110px] lg:mx-auto md:px-10">
        <h1 className="text-[32px] leading-[36px] font-dm-serif tracking-[-0.246px] font-normal text-secondary-san-juan-blue text-center md:mt-10 lg:text-[56px] lg:leading-[56px] lg:text-left md:max-w-[573px] md:mx-auto md:text-[48px] md:leading-[56px] md:tracking-[-0.369px]">
          We empower innovators by delivering access to the financial system
        </h1>

        <div className="mt-10 flex flex-col gap-4 items-center text-center md:mt-[54px] md:flex-row md:items-start">
      ...
      <div>
        ...
        />
        <img src={teamMemberDesktop} className="hidden lg:block w-full" />
      </div>

      <div className="px-6 md:px-10">
        {/* SEPARATOR */}
        <div className="w-full h-[1px] bg-secondary-san-juan-blue  mt-12 md:hidden"></div>

        <div className="flex flex-col gap-8 items-center text-center py-4 md:flex-row md:gap-[10px] md:py-0">
          <div className="flex flex-col items-center text-center md:flex-1 md:text-left md:items-start">
            <div className="hidden md:block w-full h-[1px] bg-secondary-san-juan-blue  mt-12 mb-[44px]"></div>
            ...
            <div className="hidden md:block w-full h-[1px] bg-secondary-san-juan-blue  mt-4"></div>
          </div>
        ...
        {/* SEPARATOR */}
        <div className="w-full h-[1px] bg-secondary-san-juan-blue  mb-12 md:hidden"></div>
      </div>

      <div className="px-6 lg:max-w-[1110px] lg:mx-auto mb-12 md:px-10 md:mb-[72px]">
        <div className="mt-10 flex flex-col gap-4 items-center text-center md:mt-[64px] md:flex-row md:items-start">
          <h3 className="text-[24px] leading-[32px] text-secondary-san-juan-blue font-dm-serif tracking-[-0.185px] font-normal md:w-[223px] md:text-left md:flex-shrink-0 md:gap-[10px]">
            The Culture
          </h3>
