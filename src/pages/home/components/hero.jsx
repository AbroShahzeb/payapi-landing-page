...
export const Hero = () => {
  return (
    <header className="relative pb-20 md:pb-[100px] overflow-hidden">
      ...
      <div className="absolute w-[780px] h-[780px] md:w-[949px] md:h-[949px] left-1/2 -translate-x-1/2 bottom-0  -translate-y-[calc(100%-250px)] md:-translate-y-[calc(100%-500px)] lg:w-[780px] lg:h-[780px] lg:-translate-y-[calc(100%-650px)] lg:translate-x-[100px] ">
        <img
          src={bgPatterCircle}
      ...
      <div className="mt-8 flex flex-col gap-6 px-6 md:gap-0 lg:px-0 lg:gap-[100px] lg:flex-row-reverse lg:max-w-[1110px] lg:mx-auto relative z-40 lg:items-center ">
        ...
        <div className="flex flex-col lg:items-start gap-6 md:gap-0 md:mt-12 lg:mt-16">
          ...
          <div className="flex flex-col gap-4 md:mt-[57px] md:w-[445px] md:mx-auto lg:mx-0">
