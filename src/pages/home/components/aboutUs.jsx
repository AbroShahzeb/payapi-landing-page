...
export const AboutUs = () => {
  return (
    <section className="bg-secondary-mirage-blue py-20 px-6 md:py-[90px] md:px-[116px] relative overflow-hidden">
      {/* Circle Pattern */}
      <div className="w-[780px] h-[780px] rounded-full bg-secondary-san-juan-blue/20 absolute z-10 left-1/2 -translate-x-1/2 bottom-0 -translate-y-[calc(100%-100px)] md:-translate-y-1/2"></div>
      ...
      <div className="flex flex-col text-center mt-20 md:mt-16 relative z-20">
        ...
        <p className="mt-4 md:mt-6 text-primary-water-white/75 text-[15px] leading-[28px] font-normal text-center">
